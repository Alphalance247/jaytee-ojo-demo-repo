...
type programInterestedEnum = 'Coding For Kids' | 'Teens Coding' | 'School Coding Club' | 'Train the Trainer'
...
export const useApplicationForm = create<ApplicationStore>((set, get) => ({
    ...
    submitForm: async () => {
        ...
        try {
            ...
            await axios.post("https://site-api.alluvium.net/impact-tech/api/enrollments/", formData,
