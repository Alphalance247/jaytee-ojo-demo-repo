const HeroD = () => {
  return (
    <div
      className=" bg-center bg-cover h-[534px] relative p-24 max-sm:p-4 max-sm:h-[300px]"
      style={{
    ...
    >
      ...
      ></div>
      <div className="text-white absolute z-20 w-[849px] h-[334px] flex flex-col gap-y-6 max-sm:gap-y-3 max-sm:w-[300px]">
        ...
        <p className=" text-lg font-Roboto leading-7 w-[711px] max-sm:w-[340px] max-sm:text-sm max-sm:leading-4">
