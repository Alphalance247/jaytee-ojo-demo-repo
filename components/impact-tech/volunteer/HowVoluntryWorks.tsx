  ...
  return (
    <div className="py-10 md:py-[91px]">
      <div className="max-w-[1240px] mx-auto w-full ">
        <div className="font-inter text-center text-[#061C3D] flex flex-col items-center justify-center  md:px-0 px-6 max-w-[1174px] mx-auto">
        ...
        <div className="mx-auto w-full max-w-[1174px] flex md:flex-row flex-col items-center gap-[420px] md:gap-[217px] md:px-0 px-6 h-auto md:h-[571px] mt-10 md:mt-[67px]  ">
          <div className="w-full md:w-1/2 h-full">
            <div className="relative w-full md:w-[420px] ">
              {/* <div className="absolute w-[397px] h-[571px] top-[67px] bg-[#2A7445]/10 rounded-[20px] left-[110px] z-0 "></div> */}

              <div className="absolute w-full md:w-[397px] top-[67px] h-auto md:h-[505px]  bg-[#2A7445]/10 rounded-[20px] -left-10 md:left-[152px] z-0"></div>
              ...
              <Image
                ...
                width={425}
                height={547}
                className="rounded-[20px] w-full md:w-[425px] h-auto md:h-[547px] object-cover absolute left-0 md:left-[88px]  z-10"
              />
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 gap-10 flex flex-col pl-6 md:pl-16 ">
            ...
            <Button
              ...
              className="bg-[#E60303] hover:bg-red-700 text-white w-full md:w-[211px]"
