...
const AboutTheProgram = () => {
  return (
    <div className="w-full">
      <div
        className="mt-[60px] md:mt-[126px] px-6 md:px-0 flex md:flex-row flex-col gap-6  h-fit md:h-[624px] items-start max-w-[1219px] mx-auto
     "
      >
        <div className="w-full md:w-[1/2]">
          ...
          <p className="text-[#121212] text-[15px] md:text-base w-full md:w-[513px] font-inter">
            ...
            technology through hands-on learning, real-world projects, and
            guided mentorship. Students develop foundational coding skills while
            building confidence, creativity, and problem-solving abilities.
            Beyond technical skills, the program helps teens understand how
            technology shapes the world, prepares them for future careers, and
            equips them with tools to become creators—not just consumers—of
            technology.
          </p>
        </div>
        <div className="w-full md:w-1/2 ">
