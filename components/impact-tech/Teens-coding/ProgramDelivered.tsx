...
const ProgramDelivered = () => {
  return (
    ...
    >
      <div className="bg-[url('/assets/impact-tech/hand-trophy.png')] bg-no-repeat"></div>
      <div className=" px-6 md:px-0 max-w-[1225px] mx-auto">
        <div className="grid gap-6 w-full max-w-[684px] mb-[44px] md:mb-[88px] ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 justify-between gap-8  md:pb-0 pb-10 max-w-[1219px] mx-auto">
