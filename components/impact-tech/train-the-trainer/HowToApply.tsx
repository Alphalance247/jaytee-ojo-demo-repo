      ...
      <div className=" mx-auto w-full md:max-w-[1174px] flex md:flex-row flex-col items-center gap-[420px] md:gap-[217px]   h-auto md:h-[571px] mt-10 md:mt-[67px] md:mb-24 mb-0">
        <div className="w-full md:w-1/2 h-full md:block hidden">
          <div className="relative w-full md:w-[420px]  ">
            ...
            <Image
              src="/assets/impact-tech/train-the-trainer/Images1.png"
              alt="Volunteer"
              width={425}
              height={571}
              className="rounded-tl-[20px] w-[425px] h-[571px] object-cover absolute left-0 md:left-[41px] z-10 "
            />
          </div>
        </div>

        <div className="w-full md:w-1/2 gap-10 flex flex-col pl-6 md:pl-16 md:mt-0 mt-20 ">
