...
const ReadyToTransformEducation = () => {
  return (
    <div className="bg-[#201D1F] bg-impact-gradient rounded-[16px] h-[450px] w-full shadow-[0px_4px_10px_0px_#0000004D,_inset_0px_1px_0px_0px_#FFFFFF0F]">
      <div className="mx-auto max-w-[1219px] flex justify-center items-center flex-col gap-10 h-[450px]">
        <div>
          <h6 className="font-semibold font-grostek text-white text-3xl md:text-5xl text-center">
            Ready to Transform Digital Education?
          </h6>

          <p className="text-center text-white font-inter font-normal text-base md:text-lg px-6 w-full max-w-[722px] pt-6">
        ...
        <div>
          <Link
            ...
            className="flex gap-1 justify-center items-center h-[60px] w-[190.81px] border-2 border-[#00BC7D] rounded-[10px] bg-[#007A55] hover:bg-[#009966]"
          >
