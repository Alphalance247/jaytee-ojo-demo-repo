...
const ApplicationCard = ({
  ...
  return (
    <div className="flex justify-center items-center h-[246px] px-[33px] w-full md:w-[454px] rounded-[16px] bg-[linear-gradient(135deg,_#ECFDF5_50%,_#FFFFFF_100%)] border border-[#A4F4CF]">
