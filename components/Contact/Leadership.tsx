...
const Leadership = () => {
  return (
    <Container>
      <div className="grid grid-cols-2 gap-x-20 bg-white max-sm:grid max-sm:grid-cols-1 max-sm:gap-y-8 max-md:grid max-md:grid-cols-2 max-md:gap-x-8">
        <div className=" flex flex-col justify-start items-start gap-y-8 max-sm:gap-4 max-sm:items-start max-sm:justify-center max-md:gap-y-2">
          ...
          <p className=" text-[#595959] text-base font-Roboto font-normal max-sm:text-[14px] max-md:text-base">
            ...
            arcu sollicitudin. Sed viverra sed consectetur viverra. Magna eget
            nibh pellentesque dictumst egestas sed tincidunt. Erat ullamcorper
            netus. Lorem ipsum dolor sit amet consectetur. Facilisi posuere a
            purus pellentesque. Risus natoque velit nisl a elementum quam. Urna
            lacus egestas maecenas venenatis est ut in lorem feugiat. At purus
            netus nisl magna pharetra eget vitae cum. A at nec at tincidunt
            tortor arcu sollicitudin. Sed viverra sed consectetur viverra. Magna
            eget nibh pellentesque dictumst egestas sed tincidunt. Erat
            ullamcorper netus.
          </p>
        </div>
