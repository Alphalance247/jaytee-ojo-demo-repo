...
const HeroNews = () => {
  return (
    <div
      className="bg-center bg-cover h-[640px] relative p-24 max-sm:p-4 max-sm:h-[300px] max-md:p-8 max-lg:p-10"
      style={{
        background: 'url("../assets/news/hero.png")',
      }}
    >
      <div className="absolute top-0 left-0 w-[57%] h-[100%] z-10 bg-[#205A35]"></div>
      <div className="text-white absolute z-20 w-[561px] h-[334px] flex flex-col items-start gap-y-6 max-sm:gap-y-3 max-sm:w-[300px] max-md:w-[450px]">
