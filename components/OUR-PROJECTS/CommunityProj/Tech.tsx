...
const Tech = () => {
  return (
    <div className="p-24 border-t-2 border-[#D9D9D9] max-sm:p-4 max-md:p-8">
      <div className="flex items-center gap-72 px-16 max-sm:grid max-sm:gap-y-4 max-sm:px-4 max-md:px-8 max-md:gap-20">
        <div className="flex flex-col gap-y-4 w-[568px] max-sm:w-[300px] max-sm:gap-y-2 max-sm:grid">
        ...
        <button
          ...
          className="py-2 px-4 rounded  font-Roboto text-base font-black text-white bg-[#3BA361]"
        >
          LEARN MORE
        </button>
      </div>
