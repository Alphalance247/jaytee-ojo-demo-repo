  ...
  return (
    <div className=" p-24 text-center flex flex-col gap-y-4 max-sm:p-4 max-sm:gap-y-2 max-md:p-8 max-lg:p-12">
      ...
      <p className="text-[#595959] text-base font-Roboto w-[80%] m-auto max-sm:text-sm max-sm:w-[100%] max-md:w-[100%]">
        Every project leaves a lasting legacy of change, showcasing the tangible
        impact of our dedication. From educational programs to healthcare
        initiatives, each one leaves an indelible mark on the communities it
        serves.
      </p>
    </div>
  );
