...
const Story = () => {
  return (
    <section className="bg-[#F5F5F5]">
      <Container>
        <div className="grid grid-cols-2 gap-x-20  max-sm:grid max-sm:grid-cols-1 max-sm:gap-y-8 max-md:grid max-md:grid-cols-2 max-md:gap-x-8">
          ...
          <div className=" flex flex-col items-start gap-y-4 max-sm:gap-4 max-sm:items-center max-sm:justify-center max-md:gap-y-2">
            <h1 className=" text-[#262626] font-RobotoSlab text-3xl font-bold max-sm:text-[2rem] max-sm:text-left max-md:text-[20px]">
              Our Story
            </h1>
            <p className=" text-[#595959] text-lg font-Roboto font-normal max-sm:text-[1rem] max-md:text-base">
              ...
              up communities at night, we have donated borehole water fountains,
              we have sponsored several medical interventions, food banks,
              sports intervention as well as farmer empowerment and local
            ...
            <p className="text-[#595959] text-lg font-Roboto font-normal max-sm:text-[1rem] max-md:text-base mb-8">
              ...
              students, to multiple scholarship programmes that cover school
              fees, various examination registration fees, accommodation, and
              projects support.
            </p>
            <Link href={"/our-story"}>
