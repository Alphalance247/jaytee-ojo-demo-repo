...
const Inspire = () => {
  return (
    <Container>
      <div
        className="grid gap-x-20 justify-between max-sm:flex max-sm:items-center max-sm:flex-col max-sm:gap-y-10  max-md:flex max-md:gap-x-8"
      ...
      >
        <div className="flex flex-col items-start gap-4">
          ...
          <p className="text-[#595959] text-lg font-Roboto font-normal max-sm:text-base max-md:text-base">
            What do you want to be in future? What do you want to be when you
            grow up? I remember being asked this question as a little boy and
            you may have been asked the same question in a variety of ways. When
            I was a boy, I wanted to be a doctor however at the age of 13, I
            started my first business and my first money.
          </p>
