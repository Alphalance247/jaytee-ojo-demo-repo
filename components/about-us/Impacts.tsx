...
const Impacts: React.FC<{
  ...
  return (
    <Container>
      <div
        className={`${width} pb-24 m-auto border-b border-[#D9D9D9]  ${backgroundCol} ${border} max-md:w-auto max-md:pb-6`}
      >
          ...
          {Data.map((items) => {
            return (
              <div key={items.id}>
                ...
                <div className="flex gap-x-4 pt-4 items-start max-md:gap-x-2 max-md:pt-2">
