        ...
        <section className="">
          ...
          <div className="flex flex-col md:flex-row gap-14">
            ...
            <div className="md:w-2/">
              <p className="text-gray-700">
                ...
                Ekiti to help make the young person globally competitive and
                help our communities towards self-sustenance.
              </p>

              <p className="mt-4 text-gray-700">
                We have, among other projects, donated solar streetlights to
                light up communities at night, provided borehole water
                fountains, and sponsored medical interventions, food banks,
                sports interventions, and local farming.
              </p>
              ...
              <p className="mt-4 text-gray-700">
                ...
                books to students, to multiple scholarship programs that cover
          ...
          <div className="space-y-4 mt-4 text">
            ...
            <p>
              ...
              or ability. This is perhaps our most interesting endeavour as we
              get to see humanity at it’s best. In our open courses, we have had
              a Consultant Medical Doctor learning alongside a Dry Cleaner, and
              we have had people who did not finish secondary school learning
              with a someone who holds a PhD. We have delivered open training in
              Python, Digital Design, Digital Marketing, HTML, CSS and
              JavaScript as well as Excel and Database Administration.
            </p>
            <p>
              Finally, we are really excited to make available in print, some
              open source resources that has helped us in training our schools
              club in HTML. We will follow up with CSS, JavScript and Python
              editions.
            </p>
            <p>
              We provide this book without charge and with no copy rights, to
              all public secondary schools in Ekiti State.
            </p>
            <p>
